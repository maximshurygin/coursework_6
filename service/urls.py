...
urlpatterns = [
    ...
    path('newsletters', NewsletterListView.as_view(), name='index'),
    ...
    path('newsletters/add/', NewsletterCreateView.as_view(), name='newsletter_add'),
    path('newsletters/<int:pk>/edit/', NewsletterUpdateView.as_view(), name='newsletter_edit'),
    path('newsletters/<int:pk>/delete/', NewsletterDeleteView.as_view(), name='newsletter_delete'),
    path('newsletter/<int:pk>/update_status/', ToggleNewsletterStatusView.as_view(), name='update_newsletter_status'),

    path('messages/', MessageListView.as_view(), name='messages_list'),
    path('messages/<int:pk>/', MessageDetailView.as_view(), name='messages_detail'),
    path('messages/add/', MessageCreateView.as_view(), name='messages_add'),
